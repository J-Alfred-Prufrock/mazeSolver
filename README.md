published v0.1 currently only works for recursive dfs, python has a recursion limit, ive only tested with a completly empty 100x100 and that fails it, havent made a proper 100x100 maze yet
